...
<head>
  ...
  <!-- Anti-clicking header -->
  <meta name="csrf-token" content="<?php echo htmlentities($_SESSION['csrf_token']); ?>">
</head>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="/loginRequest.php" method="post">
